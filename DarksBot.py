...
TOKEN:Final = '7615169193:AAE-tHlmsThvEO57fK86aTOnX-bufKs9myw'
...
async def start_command(update:Update, context:ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Hello and welcome to DarkCentepede's Bot! You can ask me any question.")
